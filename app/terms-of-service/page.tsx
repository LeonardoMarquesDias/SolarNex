        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700">
              By accessing and using Smart Solar's website and services, you accept and agree
          ...
          <section>
            ...
            <p className="text-gray-700">
              Smart Solar's liability is limited to the value of services provided.
